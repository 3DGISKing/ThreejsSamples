...
let renderTargetInspector;

// from https://github.com/Fyrestar/THREE.RenderTargetInspector
...
class Viewer {
    ...
    _initThreejs(){
       ...
       // camera.lookAt(new Vector3(0, 0, 0))
        ...
        renderTargetInspector = new THREE.RenderTargetInspector( renderer, 256, 'left' );
    ...
    _setupMyScene(){
        const geometry = flipY( new THREE.PlaneBufferGeometry(sceneBoundingRadius, sceneBoundingRadius) );
        ...
        let texture = loader.load( '../../textures/planets/earth_atmos_2048.jpg' );

        material.map = texture;

        renderTargetInspector.add(renderTarget, 'render target');
    }
