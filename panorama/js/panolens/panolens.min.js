...
container:b}),a.dispatchEvent({type:"panolens-informationInfospot-focus",method:function(a,b,d){this.dispatchEvent({type:"panolens-viewer-handler",method:"tweenControlCenter",data:[a,b,d]})}.bind(this)}));d.Object3D.prototype.add.call(this,a)},getTexture:function(){return this.material.uniforms.tEquirect.value},load:function(){this.onLoad()},onClick:function(a){a.intersects&&0===a.intersects.length&&this.traverse(function(a){a.dispatchEvent({type:"dismiss"})})},setContainer:function(a){if(a instanceof HTMLElement)var b=
